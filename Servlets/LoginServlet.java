...
public class LoginServlet extends HttpServlet {
    ...
    /*
     * Looks for a user by using the credentials in the Java DB 
     * Once found Login is done and the scoreboard is displayed.
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean foundUser = userInfoBean.login(uname, password);
            ...
            if (!foundUser) {
                ...
                out.println("<h1>User with name "+uname+" and password not found ! </h1>");
            }
            else {
